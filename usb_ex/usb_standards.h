...
typedef struct {
    ...
    void (*control_transfer_handle)(unsigned int EPNum, unsigned short bcnt);
    void (*on_out_data_received)(unsigned int EPNum, unsigned short bcnt);
    void (*on_in_transfer_completed)(unsigned int EPNum);
    void (*on_out_transfer_completed)(unsigned int EPNum);
    void (*on_usb_polled)(void);
    void (*on_endpoint_handle)(unsigned int EPNum, unsigned int u32IntStatus);
} USBEvents;
